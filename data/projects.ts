...
export const projects: Project[] = [
  ...
  },
  {
    slug: "weathersight",
    title: "Weathersight",
    subtitle: "Climate data platform",
    disciplines: ["design", "code"],
    type: "product",
    ...
    overview: "Brought on by Weathersight to do two things: carve out a distinct brand identity and build an enticing landing page. Known for precise, exhaustive global weather information, Weathersight equips media outlets and publications with dependable data to monitor long-term climate change and extreme weather events.",
    blocks: [
      {
        type: "image",
      ...
      {
        type: "prose",
        content: "I crafted a custom Bootstrap theme integrated into the site, communicating Weathersight's mission and impact to potential investors and broader audiences.",
      },
      {
        type: "grid",
        images: [
  ...
  },
  {
    ...
    shortDescription: "Award-winning online sneaker configurator with real-time 360 customization, built with Fluid's creative team, including a collaboration with John Maeda.",
    overview: "As lead UX developer for RbkCustom by Reebok, I collaborated with Fluid's creative team to build Reebok's groundbreaking, award-winning online sneaker configurator. A tour de force in client-side rendering and production techniques, offering users a real-time 360-degree view of their customized shoe designs.",
    blocks: [
      {
        type: "image",
