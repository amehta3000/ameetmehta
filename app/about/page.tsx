  ...
  return (
    <div className="mx-auto max-w-4xl px-6">
      ...
      <div className="space-y-8 pb-24 text-base leading-relaxed text-muted">
        ...
        <p>
          Right now I mostly consult with small and medium-sized businesses who
          need to move faster without hiring a full team: workflow analysis,
          product design, creative direction, sometimes all at once. If your
          problem doesn&apos;t fit a clean job description, that&apos;s usually
          a good sign we&apos;d work well together.
        </p>
        <p>
          Parallel to all of it, I make music. Beats, mostly, but also
          generative art and intuition-driven code. It&apos;s a studio practice:
          work done on its own terms, on its own schedule, that keeps the
          consulting side honest.
        </p>
